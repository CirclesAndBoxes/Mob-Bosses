...
execute as @e[type=evoker,tag=chainerEvoker,nbt={SpellTicks:39},scores={rng=0..20}] at @s run particle end_rod ~ ~ ~ 0.2 0.2 0.2 0.1 10 normal
...
execute as @e[type=evoker,tag=chainerEvoker,nbt={SpellTicks:39},scores={rng=21..40}] at @s run particle white_ash ~ ~ ~ 0.2 0.2 0.2 0.1 10 normal
...
execute as @e[type=evoker,tag=chainerEvoker,nbt={SpellTicks:39},scores={rng=41..60}] at @s run particle portal ~ ~ ~ 0.2 0.2 0.2 0.1 10 normal
...
execute as @e[type=evoker,tag=chainerEvoker,nbt={SpellTicks:39},scores={rng=61..80}] at @s run particle white_ash ~ ~ ~ 0.2 0.2 0.2 0.1 10 normal
...
execute as @e[type=evoker,tag=chainerEvoker,nbt={SpellTicks:39},scores={rng=81..99}] at @s run particle small_flame ~ ~ ~ 0.2 0.2 0.2 0.1 10 normal

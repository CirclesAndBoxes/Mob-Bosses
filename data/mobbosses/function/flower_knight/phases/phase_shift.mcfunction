...
execute unless entity @e[type=husk,limit=1,sort=nearest,tag=flowerKnightHitbox] run summon husk ~ ~ ~ {Tags:["flowerKnightHitbox","hitboxInit"],attributes:[{id:"minecraft:generic.max_health",base:120},{id:"minecraft:generic.knockback_resistance",base:100.0}],Health:120f,DeathLootTable:"",NoAI:1b,Silent:1b,PersistenceRequired:1b,active_effects:[{id:"minecraft:invisibility", duration: 999999999, show_particles: false}], Invulnerable:1b}

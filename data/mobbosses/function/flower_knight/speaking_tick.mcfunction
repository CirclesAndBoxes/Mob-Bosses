...
execute if score @s BossStage matches 3 if score @s BossTimer matches 160 run data merge entity @s {CustomName:'{"text":"Blossom Knight","color":"dark_purple"}',ArmorItems:[{id:"minecraft:leather_boots",count:1b,components:{dyed_color:15875314,trim:{material:"minecraft:emerald",pattern:"minecraft:spire"}}},{id:"minecraft:leather_leggings",count:1b,components:{dyed_color:15875314,trim:{material:"minecraft:emerald",pattern:"minecraft:spire"}}},{id:"minecraft:leather_chestplate",count:1b,components:{dyed_color:15875314,trim:{material:"minecraft:emerald",pattern:"minecraft:spire"}}},{id:"minecraft:player_head",count:1b,components:{profile:{id:[I;1985969071,-421115021,-1624534344,-956178759],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTk2MDY2MzM2MzkyZjQwMTU4NTllZWM5M2E5ZTBkZjBmM2ExZWNlMDhiY2I1MmI4NDY4ZTYwNTZhZWFiMDRkYSJ9fX0="}]}}}],HandItems:[{id:"minecraft:golden_sword",count:1b},{}],DisabledSlots:4144959,Pose:{RightArm:[0f,0f,80f]}}

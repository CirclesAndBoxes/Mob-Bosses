...
execute as @a[scores={MB_Gunfire=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{Enchantments:[{id:"piercing",lvl:7}]}}}] at @s rotated as @s anchored eyes run tag @s add Defended
execute as @a[scores={MB_Gunfire=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{Enchantments:[{id:"piercing",lvl:7}]}}}] at @s rotated as @s anchored eyes positioned ^ ^ ^ run function mobbosses:firing
execute as @a[scores={MB_Gunfire=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{Enchantments:[{id:"piercing",lvl:7}]}}}] at @s run tag @s remove Defended
...
#Pillager
execute as @e[tag=SuperRapidPillager,type=pillager] at @s run data merge entity @s {HandItems:[{id:"minecraft:crossbow",Count:1,tag:{Unbreakable:1b,Charged:1b,ChargedProjectiles:[{id:"minecraft:tipped_arrow",Count:1,tag:{Potion:"harming"}}]}},{id:"minecraft:tipped_arrow",Count:64,tag:{Potion:"harming"}}]}
...
execute as @e[tag=IronBoss,scores={BossStage=3..,BossTimer=60}] at @s rotated as @s run playsound entity.iron_golem.hurt hostile @a[distance=20..] ~ ~ ~ 30 0.8 
...
execute as @e[tag=mb_inCharge,nbt={OnGround:1b}] at @s run summon creeper ~ ~1.5 ~ {Fuse:0,ignited:1,ExplosionRadius:3,CustomName:'{"text":"Charge"}'}

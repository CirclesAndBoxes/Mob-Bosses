...
#flower knight?
#bloom protector?
summon armor_stand ~ ~ ~ {NoBasePlate:1b,ShowArms:1b,CustomName:'{"text":"Blossom Knight","color": "magenta"}',ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:15875314},Trim:{material:"minecraft:emerald",pattern:"minecraft:spire"}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:15875314},Trim:{material:"minecraft:emerald",pattern:"minecraft:spire"}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:15875314},Trim:{material:"minecraft:emerald",pattern:"minecraft:spire"}}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;1985969071,-421115021,-1624534344,-956178759],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvNTk2MDY2MzM2MzkyZjQwMTU4NTllZWM5M2E5ZTBkZjBmM2ExZWNlMDhiY2I1MmI4NDY4ZTYwNTZhZWFiMDRkYSJ9fX0="}]}}}}],HandItems:[{id:"minecraft:golden_sword",Count:1b},{}],DisabledSlots:4144959,Pose:{RightArm:[0f,0f,0f]},Tags:["flowerKnight","flowerKnightInit"],Attributes:[{Name:"minecraft:generic.max_health",Base:100}],Health:100f,Invulnerable:1b}

...
execute if score #RegenType mb_RegenType matches 1001 run gamerule naturalRegeneration false
execute if score #RegenType mb_RegenType matches 1002 run gamerule naturalRegeneration true
